...
// Map Arduino IDE board definitions to our board definitions
...
// Use maritime configuration if defined
#ifdef BOARD_ONDOCEAN_MARITIME
#ifndef BOARD_ESP32S3_DEV
#define BOARD_ESP32S3_DEV
#endif
#endif
...
#elif defined(BOARD_ONDOCEAN_MARITIME)
#define BOARD_ID 10
#define PIN_CAN_TX GPIO_NUM_47
#define PIN_CAN_RX GPIO_NUM_38
